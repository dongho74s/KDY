...
class CarrotMan:
  ...
  def carrot_curve_speed_params(self):
    self.autoCurveSpeedFactor = self.params.get("AutoCurveSpeedFactor")*0.01
    self.autoCurveSpeedAggressiveness = self.params.get("AutoCurveSpeedAggressiveness")*0.01
